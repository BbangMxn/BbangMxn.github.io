...
<section class="hub-section">
  <p class="hub-section-kicker">Tracks</p>
  <h3>현재 트랙</h3>
  <ul class="hub-list">
    <li class="hub-item">
      <a href="./Cache">
...
<section class="hub-section">
  <p class="hub-section-kicker">How To Read</p>
  <h3>읽는 방법</h3>
  <ul class="hub-list">
    <li class="hub-item">
      <div class="hub-note">
        <span class="hub-label">Start From Root</span>
  ...
  <ul class="hub-list">
    <li class="hub-item">
      <a href="../projects">
        ...
        <p>리서치에서 정리된 질문이 실제 구현과 구조 선택으로 이어진 결과물은 Projects 허브에서 모아봅니다.</p>
      </a>
    </li>
  </ul>
</section>
