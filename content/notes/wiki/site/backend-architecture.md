...
cssclasses:
  - research-note
aliases:
  - wiki/site/backend-architecture
---
...
- 현재 포트폴리오에서 이 역할을 맡는 대표 프로젝트는 [BagInDB](../../../projects/bagindb/index.md), [Worker](../../../projects/worker/index.md), [Nazgul](../../../projects/nazgul/index.md), [Smart Factory](../../../projects/smartfactory/index.md)입니다.
...
1. [BagInDB](../../../projects/bagindb/index.md) 메인 페이지의 아키텍처 섹션으로 작은 읽기 중심 API 구조를 봅니다.
2. [Worker](../../../projects/worker/index.md) 메인 페이지의 아키텍처 섹션으로 프로세스 분리와 헥사고날 구조를 봅니다.
3. [Nazgul](../../../projects/nazgul/index.md) 메인 페이지의 아키텍처 섹션으로 RAG 서버 모듈 분리를 봅니다.
4. [Smart Factory](../../../projects/smartfactory/index.md) 메인 페이지의 아키텍처 섹션으로 파이프라인형 백엔드 구조를 봅니다.
