...
<section class="hub-section">
  ...
  <ul class="hub-list">
    ...
    <li class="hub-item">
      <a href="./backend-architecture.md">
  ...
  <ul class="hub-list">
    <li class="hub-item">
      <div class="hub-note">
        ...
        <p><code>minimal-home, swiss-home</code>은 홈의 소개와 주요 기록 링크를 보여줍니다.</p>
      </div>
    </li>
    <li class="hub-item">
      <div class="hub-note">
  ...
  <ul class="hub-list">
    ...
    <li class="hub-item">
      <div class="hub-note">
        ...
        <p><code>quartz.layout.ts</code>는 엔진 진입점이며, 실제 레이아웃과 위젯 조합은 <code>quartz/app/layouts/quartz.ts</code>에서 관리합니다.</p>
      </div>
    </li>
    <li class="hub-item">
      <div class="hub-note">
    ...
    <li class="hub-item">
      <div class="hub-note">
        ...
        <p>현재 사이트 스타일은 <code>quartz/app/styles/site.scss</code>에서 관리하고, <code>quartz/styles/custom.scss</code>가 Quartz 기본 스타일과 연결합니다.</p>
      </div>
    </li>
  </ul>
</section>
