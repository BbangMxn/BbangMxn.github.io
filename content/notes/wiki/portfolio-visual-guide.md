...
cssclasses:
  - folder-hub
aliases:
  - wiki/portfolio-visual-guide
---

<div class="hub-header">
  <p class="hub-kicker">위키 / 시각</p>
  <h2>미니멀 포트폴리오의 시각 규칙</h2>
  <p class="hub-lede">
...
<section class="hub-section">
  ...
  <ul class="hub-list">
    <li class="hub-item">
      <div class="hub-note">
        <span class="hub-label">섹션</span>
        <p>섹션은 배경 박스보다 간격과 상단 구분선으로 나눕니다. 대신 섹션 간 패딩 차이가 충분히 커서 한 눈에 다른 블록으로 읽혀야 합니다.</p>
      </div>
    </li>
    <li class="hub-item">
      <div class="hub-note">
        <span class="hub-label">링크</span>
        <p>문서형 메모(`hub-note`)와 링크형 리스트(`hub-item > a`)는 같은 톤을 쓰더라도 상호작용 신호는 분리합니다. hover, 라벨, 미세한 강조선 차이가 필요합니다.</p>
      </div>
    </li>
    <li class="hub-item">
      <div class="hub-note">
        <span class="hub-label">증거</span>
        <p>증거 영역(`실행 화면`)은 일반 문단보다 한 단계 더 눈에 띄어야 합니다. 다만 전체 카드 박스보다 미디어, 수치, 핵심 문장에 시선을 모으는 방식이 현재 사이트 톤에 더 맞습니다.</p>
      </div>
    </li>
    <li class="hub-item">
      <div class="hub-note">
    ...
    <li class="hub-item">
      <div class="hub-note">
        <span class="hub-label">모바일</span>
        <p>모바일에서는 박스보다 흐름이 더 중요합니다. 세로 간격, 제목 크기 감소, 미디어 높이 제한, 버튼 폭 확장처럼 읽는 순서가 끊기지 않도록 재배치해야 합니다.</p>
      </div>
    </li>
    <li class="hub-item">
      <div class="hub-note">
        <span class="hub-label">한글 기준</span>
        <p>한글 페이지에서는 대문자 기반 라벨 체계와 과한 자간을 피하고, 짧은 제목과 세로 흐름을 우선합니다. 같은 양의 정보를 넣더라도 한 줄당 부담을 줄이는 편이 더 한국어답게 읽힙니다.</p>
      </div>
    </li>
  </ul>
</section>
