...
<div class="hub-header">
  <p class="hub-kicker">위키</p>
  <h2>기준과 공통 언어</h2>
  <p class="hub-lede">
    반복해서 참고할 개념, 문서 규격, 운영 기준을 안정적인 형태로 남기는 섹션입니다.
    프로젝트와 연구를 읽다가 다시 확인해야 하는 기준 문서는 여기로 모읍니다.
  </p>
</div>
  ...
  <ul class="hub-list">
    ...
    <li class="hub-item">
      <a href="./Java/index.md">
        ...
        <p>Java 리서치와 연결되는 기본 개념을 정리해 둔 문서 묶음입니다.</p>
      </a>
    </li>
    <li class="hub-item">
      <a href="./Algorithm/Index.md">
    ...
    <li class="hub-item">
      <a href="../../about.md">
        ...
        <p>이 사이트를 왜 만들었는지와 문서를 어떤 기준으로 배치하는지는 소개 페이지에서 설명합니다.</p>
      </a>
    </li>
    <li class="hub-item">
      <a href="./portfolio-standard.md">
