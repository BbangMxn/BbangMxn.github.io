...
<section class="portfolio-intro portfolio-hero">
  <div class="portfolio-hero-main">
    ...
    <p class="portfolio-lede">
      검색 구조, 제품 전환, 시계열 파이프라인, AI 업무 자동화처럼 먼저 경계를 다시 정의해야 하는 문제를 다룹니다.
    ...
    <div class="portfolio-chip-list">
      ...
      <span class="portfolio-chip">RAG / Workflow / Realtime</span>
    </div>
    ...
    <div class="portfolio-meta-strip">
      <p>
        <span>강한 문제</span>
        검색 구조 · 도메인 분리 · 시계열 파이프라인 · AI workflow safety
      </p>
      <p>
        <span>작업 기준</span>
...
<section class="portfolio-block">
  ...
  <div class="portfolio-grid portfolio-facts-grid">
    ...
    <article class="portfolio-card">
      ...
      <strong>검색 구조, 도메인 분리, 시계열, AI workflow</strong>
    ...
    <article class="portfolio-card">
      ...
      <strong>Java, Spring Boot, Go, TypeScript, Flutter, Redis, TimescaleDB</strong>
      <p>프로젝트에 따라 검색 실험, 제품 전환, 실시간 파이프라인, 업무 자동화 구조를 이 조합으로 풀었습니다.</p>
    </article>
  </div>
</section>
...
<section class="portfolio-block">
  ...
  <div class="portfolio-grid portfolio-project-grid">
    ...
    <a class="portfolio-project-card" href="./projects/smartfactory">
      <span class="portfolio-badge">시계열 파이프라인</span>
      <strong>Smart Factory</strong>
      <p>다중 프로토콜 수집, 시계열 저장, 실시간 전송, 알림 흐름을 연구와 구현으로 함께 정리한 프로젝트입니다.</p>
      <p class="portfolio-card-meta">OPC UA / MQTT -&gt; TimescaleDB / Redis / WebSocket · collector / pipeline / alert</p>
      <p class="portfolio-card-role">역할: 아키텍처 정리, 프로토콜 분석, 백엔드 구현 방향 설계</p>
    </a>
  </div>
</section>
...
<section class="portfolio-block">
  ...
  <div class="portfolio-grid portfolio-facts-grid">
    ...
    <article class="portfolio-card">
      <span class="portfolio-badge">Realtime / Data</span>
      <strong>Go, Redis, TimescaleDB, WebSocket, MQTT</strong>
      <p>수집, 저장, 실시간 전달, 알림까지 이어지는 파이프라인을 연구와 구현 구조 양쪽에서 설명합니다.</p>
    </article>
    <article class="portfolio-card">
