...
<section class="hub-section">
  ...
  <div class="hub-grid">
    ...
    <div class="hub-card">
      ...
      <strong>Worker는 업무 자동화와 구조 단순화 판단을 보여주는 보강 프로젝트입니다</strong>
      <p>메인 3개 밖에서도 AI 제안 안전장치, 분류 파이프라인, 구조 재단순화 판단을 보고 싶다면 Worker로 이어지면 됩니다.</p>
    </div>
  </div>
</section>
...
<section class="hub-section">
  ...
  <ul class="hub-list">
    ...
    <li class="hub-item">
      <div class="hub-note">
        <span class="hub-label">스마트 팩토리 축</span>
        <p><a href="./smartfactory">Smart Factory</a>는 다중 프로토콜 수집, 시계열 저장, 실시간 전송, alert 흐름을 연구와 구현으로 함께 정리한 제조 백엔드 축입니다.</p>
      </div>
    </li>
  </ul>
</section>
  ...
  <ul class="hub-list">
    <li class="hub-item">
      <div class="hub-note">
        ...
        <p>프로젝트 수를 늘리지 않고 설명력이 큰 다섯 개만 남겼습니다. 검색, 제품 구조 전환, 스마트팩토리 파이프라인, 업무 자동화, 도메인 분리처럼 서로 다른 문제 축이 겹치지 않도록 골랐습니다.</p>
      </div>
    </li>
    <li class="hub-item">
      <div class="hub-note">
